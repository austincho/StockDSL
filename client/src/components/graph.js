...
class Graph extends Component {
    ...
    createDocument() {
        ...
        Object.keys(items).forEach(function(key){
            ...
            csv += dataForDay["1. open"] + ",";
            csv += dataForDay["2. high"] + ",";
            csv += dataForDay["3. low"] + ",";
            csv += dataForDay["4. close"] + ",";
            csv += dataForDay["5. volume"] + "\n";
            dataset.push({
                "date": key,
                "open" : dataForDay["1. open"],
                "high" : dataForDay["2. high"],
                "low" :dataForDay["3. low"]
        });
        });
        ...
        var dataYrange = [0, d3.max(dataset, function(d) { return d.high; })];
    ...
    // clipPath is used to keep line and area from moving outside of plot area when user zooms/scrolls/brushes
      ...
      .attr("class", "focus")
      .attr("transform", "translate(" + "-500" + "," + margin.bottom + ")");
    ...
    render() {
        return (
            <div className="Graph">
            <button onClick={() => this.createDocument()}>Enter</button>
